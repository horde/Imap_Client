...
class SearchTest extends TestCase
{
    ...
    public function testFlagQuery($flags, $fuzzy, $expected)
    {
        ...
        foreach ($flags as $val) {
            $ob->flag($val[0], $val[1], ['fuzzy' => $fuzzy]);
        }
    ...
    public static function flagQueryProvider()
    {
        return [
            [
                [
    ...
    {
        $ob = new Horde_Imap_Client_Search_Query();
        $ob->newMsgs($newmsgs, ['fuzzy' => $fuzzy]);
    ...
    public static function newMsgsQueryProvider()
    {
        return [
            [true, false, 'NEW'],
            [false, false, 'OLD'],
            [true, true, 'FUZZY NEW'],
            [false, true, 'FUZZY OLD'],
        ];
    }
    ...
    {
        $ob = new Horde_Imap_Client_Search_Query();
        $ob->headerText('Foo', 'Bar', $not, ['fuzzy' => $fuzzy]);
    ...
    public static function headerTextQueryProvider()
    {
        return [
            [false, false, 'HEADER FOO Bar'],
            [true, false, 'NOT HEADER FOO Bar'],
            [false, true, 'FUZZY HEADER FOO Bar'],
            [true, true, 'FUZZY NOT HEADER FOO Bar'],
        ];
    }
    ...
    {
        $ob = new Horde_Imap_Client_Search_Query();
        $ob->text('foo', $body, $not, ['fuzzy' => $fuzzy]);
    ...
    public static function textQueryProvider()
    {
        return [
            [true, false, false, 'BODY foo'],
            [false, false, false, 'TEXT foo'],
            [true, true, false, 'NOT BODY foo'],
            [false, true, false, 'NOT TEXT foo'],
            [true, false, true, 'FUZZY BODY foo'],
            [false, false, true, 'FUZZY TEXT foo'],
            [true, true, true, 'FUZZY NOT BODY foo'],
            [false, true, true, 'FUZZY NOT TEXT foo'],
        ];
    }
    ...
    {
        $ob = new Horde_Imap_Client_Search_Query();
        $ob->size(100, $larger, $not, ['fuzzy' => $fuzzy]);
    ...
    public static function sizeQueryProvider()
    {
        return [
            [true, false, false, 'LARGER 100'],
            [false, false, false, 'SMALLER 100'],
            [true, true, false, 'NOT LARGER 100'],
            [false, true, false, 'NOT SMALLER 100'],
            [true, false, true, 'FUZZY LARGER 100'],
            [false, false, true, 'FUZZY SMALLER 100'],
            [true, true, true, 'FUZZY NOT LARGER 100'],
            [false, true, true, 'FUZZY NOT SMALLER 100'],
        ];
    }
    ...
    {
        $ob = new Horde_Imap_Client_Search_Query();
        $ob->ids(new Horde_Imap_Client_Ids($ids), $not, [
            'fuzzy' => $fuzzy,
        ]);
    ...
    public static function idsQueryProvider()
    {
        return [
            ['1,2,3', false, false, 'UID 1:3'],
            ['1:3', true, false, 'NOT UID 1:3'],
            ['1,2,3', false, true, 'FUZZY UID 1:3'],
            ['1:3', true, true, 'FUZZY NOT UID 1:3'],
        ];
    }
    ...
    public static function dateSearchQueryProvider()
    {
        return [
            [
    ...
    {
        $ob = new Horde_Imap_Client_Search_Query();
        $ob->intervalSearch(30, $range, $not, ['fuzzy' => $fuzzy]);

        $this->assertEquals(
            $expected,
            $fuzzy ? $this->_fuzzy($ob, ['WITHIN']) : strval($ob)
        );
    }

    public static function intervalSearchQueryProvider()
    {
        return [
            [
    ...
    {
        $ob = new Horde_Imap_Client_Search_Query();
        $ob->modseq(123, $name, $type, $not, ['fuzzy' => $fuzzy]);

        $this->assertEquals(
            $expected,
            $fuzzy ? $this->_fuzzy($ob, ['CONDSTORE']) : strval($ob)
        );
    }

    public static function modseqSearchQueryProvider()
    {
        return [
            [null, null, false, false, 'MODSEQ 123'],
            [null, null, true, false, 'NOT MODSEQ 123'],
            [null, null, false, true, 'FUZZY MODSEQ 123'],
            [null, null, true, true, 'FUZZY NOT MODSEQ 123'],
            ['foo', null, false, false, 'MODSEQ "foo" all 123'],
            ['foo', null, true, false, 'NOT MODSEQ "foo" all 123'],
            ['foo', null, false, true, 'FUZZY MODSEQ "foo" all 123'],
            ['foo', null, true, true, 'FUZZY NOT MODSEQ "foo" all 123'],
            ['foo', 'all', false, false, 'MODSEQ "foo" all 123'],
            ['foo', 'all', true, false, 'NOT MODSEQ "foo" all 123'],
            ['foo', 'all', false, true, 'FUZZY MODSEQ "foo" all 123'],
            ['foo', 'all', true, true, 'FUZZY NOT MODSEQ "foo" all 123'],
            ['foo', 'shared', false, false, 'MODSEQ "foo" shared 123'],
            ['foo', 'shared', true, false, 'NOT MODSEQ "foo" shared 123'],
            ['foo', 'shared', false, true, 'FUZZY MODSEQ "foo" shared 123'],
            ['foo', 'shared', true, true, 'FUZZY NOT MODSEQ "foo" shared 123'],
            ['foo', 'priv', false, false, 'MODSEQ "foo" priv 123'],
            ['foo', 'priv', true, false, 'NOT MODSEQ "foo" priv 123'],
            ['foo', 'priv', false, true, 'FUZZY MODSEQ "foo" priv 123'],
            ['foo', 'priv', true, true, 'FUZZY NOT MODSEQ "foo" priv 123'],
        ];
    }
    ...
    {
        $ob = new Horde_Imap_Client_Search_Query();
        $ob->previousSearch($not, ['fuzzy' => $fuzzy]);

        $this->assertEquals(
            $expected,
            $fuzzy ? $this->_fuzzy($ob, ['ESEARCH', 'SEARCHRES']) : strval($ob)
        );
    }

    public static function previousSearchQueryProvider()
    {
        return [
            [false, false, 'NOT $'],
            [true, false, '$'],
            [false, true, 'FUZZY NOT $'],
            [true, true, 'FUZZY $'],
        ];
    }
    ...
    {
        $ob = new Horde_Imap_Client_Search_Query();
        $ob->ids(new Horde_Imap_Client_Ids([]));
        $ob->text('foo');
        ...
        $ob->ids(new Horde_Imap_Client_Ids([]), true);
    ...
    public static function inconsistentCharsetsInAndOrSearchesProvider()
    {
        $ob = new Horde_Imap_Client_Search_Query();
        $ob->text('foo');
        $ob->charset('UTF-8', false);
    ...
    private function _fuzzy($ob, array $exts = [])
    {
